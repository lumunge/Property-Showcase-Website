	...
	$bookingID=$_POST['bookingID'];
	 $hhpayDay=$_POST['hpayDay'];
		...
		if ($status=='Refund'){
			...
			$update1="UPDATE bookings  booking_payment='Refunded',booking_remarks='Booking Payment Refunded' WHERE booking_id='$bookingID'";
			mysqli_query($conn,$update1);
						 
	$update="UPDATE rent_payment SET payment_status='Refunded',payment_remarks='Booking payment sent back to your account' WHERE payment_no='$paymentID'";
			if (mysqli_query($conn,$update)){
				$sweet='success';
				$feedback='Booking fee refunded';
			}
...
<html lang="en">
  <head>
    ...
    <title>Rejected Booking Payment</title>
...
echo"<script>
  ...
  <section id="container" class="">
    ...
    <input type="text" class="search form-control btn-warning" placeholder="Search Here?" style="color: black;background-color: white">
					...
					<div class="col-md-3">
						<div class=""> <h4>Bookings Refunds </h4></div></div>
		            <div class="col-md-6">
		            
		    <a href="booking_payment.php"><button class="btn btn-danger btn-sm btn-primary">Paid Booking Payments</button></a>
		    <a href="rejected_booking_payment.php"><button class="btn btn-primary btn-sm btn-primary">Rejected Payments</button></a>
		       </div>
			       <script>
