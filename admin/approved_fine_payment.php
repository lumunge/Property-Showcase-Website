...
<html lang="en">
  <head>
    ...
    <title>Approved Fine Payments </title>
...
echo"<script>
  ...
  <section id="container" class="">
    ...
    <input type="text" class="search form-control btn-warning" placeholder="Search Here?" style="color: black;background-color: white">
					...
					<div class="col-md-3">
						<div class=""> Approved Fine Payments</div></div>
...
<?php
	...
	$select="SELECT * FROM bookings AS b INNER JOIN rooms AS r ON b.room_id=r.room_id RIGHT JOIN apartment AS a ON r.apartment_id=a.apartment_id RIGHT JOIN rent_payment AS rp ON b.booking_id=rp.booking_id RIGHT JOIN tenants AS t ON b.tenant_id=t.tenant_id WHERE rp.payment_status='Approved' AND rp.type_of_payment='Fine Payment'";
