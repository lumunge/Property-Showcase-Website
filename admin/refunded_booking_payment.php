...
if ($_POST['statusBtn']){
	...
	$update="UPDATE rent_payment SET payment_status='Refunded',payment_remarks='Booking payment sent back to your Mpesa account' WHERE payment_no='$paymentID'";
