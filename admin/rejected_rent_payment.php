...
echo"<script>
  ...
  <section id="container" class="">
    ...
    <input type="text" class="search form-control btn-warning" placeholder="Search Here?" style="color: black;background-color: white">
					...
					<div class="col-md-2">
						<div class=""><strong>Rejected Rent</strong></div></div>
...
<?php
	...
	$select="SELECT * FROM rent_payment AS rp INNER JOIN rooms AS r ON rp.room_id=r.room_id RIGHT JOIN tenants AS t ON rp.tenant_id=t.tenant_id RIGHT JOIN apartment AS a ON r.apartment_id=a.apartment_id WHERE rp.payment_status='Rejected' AND rp.type_of_payment='Rent Payment'";
