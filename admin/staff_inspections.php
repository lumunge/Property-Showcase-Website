...
<?php
	...
	$select="SELECT * FROM inspection_report AS ir INNER JOIN rooms AS r ON ir.room_id=r.room_id LEFT JOIN apartment AS a ON r.apartment_id=a.apartment_id WHERE ir.staff_id='".$_SESSION['staffID']."' AND ir.inspection_status='Inspected'";
