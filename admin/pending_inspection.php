...
<?php
	...
	$select="SELECT * FROM rooms AS r INNER JOIN apartment AS a on r.apartment_id=a.apartment_id RIGHT JOIN inspection_report AS ir ON r.room_id=ir.room_id RIGHT JOIN staff AS s ON ir.staff_id=s.staff_id WHERE ir.inspection_status='Pending'";
