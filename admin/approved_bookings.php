...
echo"<script>
  ...
  <section id="container" class="">
    ...
    <input type="text" class="search form-control btn-warning" placeholder="Search Here?" style="color: black;background-color: white">
		    ...
		    <a href="rejected_bookings.php"><button class="btn btn-primary btn-sm btn-primary">Rejacted Bookings</button></a>
		       </div>
			       <script>
...
<?php
	...
	$select="SELECT * FROM bookings AS b INNER JOIN rooms AS r ON b.room_id=r.room_id RIGHT JOIN apartment AS a ON r.apartment_id=a.apartment_id RIGHT JOIN tenants AS t ON b.tenant_id=t.tenant_id  WHERE booking_status='Approved'";
