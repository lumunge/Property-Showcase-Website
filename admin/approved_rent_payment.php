...
echo"<script>
  ...
  <section id="container" class="">
    ...
    <input type="text" class="search form-control btn-warning" placeholder="Search Here?" style="color: black;background-color: white">
					...
					<div class="col-md-3">
						<div class="">Approved Rent</div></div>
	       <a href="approved_rent_payment.php"><button class="btn btn-primary btn-sm btn-primary">Approved Rent</button></a>
		    ...
		    <a href="rejected_rent_payment.php"><button class="btn btn-primary btn-sm btn-primary">Rejected Rent</button></a>
		       <div class="col-md-4">
		       	<?php
				   echo $reject;
				   ?>
...
<?php
	...
	$select="SELECT * FROM rent_payment AS rp INNER JOIN rooms AS r ON rp.room_id=r.room_id RIGHT JOIN tenants AS t ON rp.tenant_id=t.tenant_id RIGHT JOIN apartment AS a ON r.apartment_id=a.apartment_id WHERE rp.payment_status='Approved' AND rp.type_of_payment='Rent Payment'";
